...
/**
 * An interface to ensure behavior of all players in the game. This includes
 * the human player and the dealer. All players in the game should implement
 * this interface.
 */
public interface Player {
  ...
  /**
   * This effectively will end the Player turn. No additional moves can be made
   * after a player stands.
   */
  void stand();
