...
public enum HandResult {
  ...
  /** When the player has two cards and a score of 21 points. Also known as a "Natural". */
  BLACKJACK,
  ...
  /**
   * The default value. This is assigned until the round is over and a result has been determined.
   */
  TBD
}
