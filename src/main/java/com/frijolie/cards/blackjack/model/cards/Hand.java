...
public interface Hand extends Comparable<Hand> {
  ...
  /**
   * Returns {@code true} if the hand contains two cards, one of which is an Ace, and the hand value
   * does not exceed 21.
   *
  ...
  /**
   * Allows the result of the hand, at the end of the round, to be set. For example, HandResult.WIN
   *
