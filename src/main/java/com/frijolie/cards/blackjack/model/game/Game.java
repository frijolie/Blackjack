...
public interface Game {
  ...
  /**
   * Calculates the winner of the round. The winner is determined by the player that has the hand
   * with the closest value to 21 without going over.
   */
  void determineWinner();

  /**
   * The main method of the game. This is where the round logic should be. It will check for proper
   * amount of players, deal the cards, and know how to cycle the turns between the human players
   * and the dealer.
   *
  ...
  /**
   * This method clears both the dealer and player hands, resets the variables and states, and makes
   * a call to playGame after all things have been reset.
   *
