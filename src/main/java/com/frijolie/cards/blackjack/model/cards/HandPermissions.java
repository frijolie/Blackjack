...
/**
 * An interface to enforce behavior of all human controlled hands in the game. Not all of these
 * methods will be available to the dealer and therefore only applicable to a Human player.
 *
 * @see BlackjackHand
 */
