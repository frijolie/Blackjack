...
public abstract class GameRules {
  ...
  /**
   * The starting funds for the player. This allows the player place bets and
   * receive proceeds from winning bets.
   *
   * @see BlackjackPlayer
   */
  ...
  /**
   * This is a flag to indicate whether the dealer must offer insurance to a
   * player. Insurance is offered if the dealer up-card is an Ace and before
  ...
  /**
   * This is a flag to indicate whether the player may elect to surrender their
   * hand. This must be done after the dealer checks for blackjack but before
   * the player makes any other move. Surrendering must be the first, and only,
  ...
  /**
   * This is a flag that will allow a player to double down on their hand. A
   * player can double down on their hand if their hand value is 9, 10, or 11.
   *
   * @see HandPermissions
   */
  ...
  /**
   * This is a flag which will allow a player to split their hand based on
   * {@link Rank}. This will only be an option when the player has only a pair
   *  of Ranks.
   *
   * <p>To split, the player removes one card from their hand and forms a new
   * Hand. They then will play their hands independently.
   *
   * <p>For example, if {@code #SPLITS_ALLOWED} is {@code true}, a player could
   *  split their hand if they were dealt Ace and Ace.
   *
   * @see HandPermissions
   * @see Card#getRank
   */
  ...
  /**
   * This is a flag which will allow a player to split their hand based on the
   * card value. This will only be an option if {@link #SPLITS_ALLOWED} is
   * {@code true} and the player is dealt cards of equal value.
   *
   * <p>To split, the player removes one card from their hand and forms a new
   * Hand. They then will play their hands independently.
   *
   * <p>For example, if {@link GameRules#SPLITS_ALLOWED} is {@code true} and
   * {@code SPLIT_ON_VALUE}
   */
